...
class DiseaseDatabase:
    ...
    def load_disease_data(self):
        ...
        return {
            "Malaria": {
                ...
                "standard_dosages": {
                    "Artemisinin-based Combination Therapies": "As per specific product guidelines",
            ...
            "HIV/AIDS": {
                ...
                "standard_dosages": {
                    "Antiretroviral Therapy": "As per combination regimen",
            ...
            "Hypertension": {
                ...
                "standard_dosages": {
                    "ACE inhibitors": "Varies by specific medication",
                    "ARBs": "Varies by specific medication",
                    "Calcium channel blockers": "Varies by specific medication",
                    "Diuretics": "Varies by specific medication",
                    "Beta-blockers": "Varies by specific medication"
                },
                "severity": "high",
            ...
            "Diabetes Mellitus (Type 2)": {
                ...
                "standard_dosages": {
                    "Metformin": "500mg twice daily, increase as tolerated",
                    "Sulfonylureas": "Varies by specific medication",
                    "SGLT2 inhibitors": "Varies by specific medication",
                    "Insulin": "Individualized based on blood glucose",
                    "GLP-1 receptor agonists": "Varies by specific medication"
                },
                "severity": "high",
                "transmission": "non_communicable",
                "incubation": "chronic",
    ...
    def get_standard_duration(self, disease_name):
        ...
        duration_map = {
            ...
            "Diabetes Mellitus (Type 2)": "Lifelong"
        }
    ...
    def get_monitoring_requirements(self, disease_name):
        ...
        monitoring_map = {
            "Malaria": ["Daily temperature", "Parasite count", "CBC"],
            ...
            "Hypertension": ["Blood pressure weekly", "Renal function", "Electrolytes"],
            "Diabetes Mellitus (Type 2)": ["Blood glucose daily", "HbA1c every 3 months", "Foot exams"]
        }
        ...
        for medication in standard_prescription["medications"][:2]:  # Limit to 2 main medications
            ...
            if patient_info:
                ...
                """, (
                    ...
                    f"Auto-generated for confirmed diagnosis: {confirmed_diagnosis}",
